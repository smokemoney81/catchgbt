...
export default function SEO() {
  useEffect(() => {
    ...
    document.title = "BaitBuddx – Angeln smarter: Fangbuch, Spots, KI & mehr";
    setMeta("name", "description", "BaitBuddx: Fangbuch, Spots, Wetter, Analyse, Community und KI-Fangberatung – DSGVO-freundlich, Dark Mode, offline nutzbar.");
    setMeta("name", "theme-color", "#0b1324");
    setMeta("name", "robots", "index, follow");

    // Open Graph
    setMeta("property", "og:title", "BaitBuddx");
